...
class User(SQLModel, table=True):
    ...
    projects: List["Project"] = Relationship(back_populates="members", link_model=UserProjectLink)
...
class Project(SQLModel, table=True):
    ...
    members: List["User"] = Relationship(back_populates="projects", link_model=UserProjectLink)
